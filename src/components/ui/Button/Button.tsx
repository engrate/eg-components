...
const buttonVariants = cva(
  'text-body focus-visible:ring-sunflower inline-flex items-center justify-center font-sans font-normal whitespace-nowrap transition-colors focus-visible:ring-1 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        primary:
      ...
      size: {
        sm: 'rounded-pill text-small px-4 py-1',
        default: 'rounded-pill text-small px-4 py-1.5',
        lg: 'rounded-pill text-body px-6 py-2',
