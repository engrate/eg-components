...
const textareaVariants = cva(
  'text-body-sm text-primary placeholder:text-quaternary flex min-h-[80px] w-full rounded-md border bg-white px-3 py-2 font-sans transition-colors focus-visible:ring-1 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50',
  {
    variants: {
      variant: {
