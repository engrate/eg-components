  ...
  render: () => (
    <div className="flex flex-col gap-1.5">
      ...
      <input
        ...
        className="h-10 w-64 rounded-md border border-border bg-bg-card px-3 font-sans text-body focus:outline-none focus:ring-2 focus:ring-sunflower focus:ring-offset-2"
      />
    </div>
  ),
}
