 ...
 *
 * In Tailwind CSS v4, the primary configuration is done via CSS
 * using the @theme directive in src/styles/index.css.
 * This file exports the tokens as JavaScript objects for programmatic access.
 */
