import{j as e}from"./jsx-runtime-u17CrQMm.js";import{S as w}from"./index-mNC3-AD3.js";import{c as y}from"./index-DDA3KdpW.js";import{r as n}from"./iframe-Dv90unGT.js";import{c as B}from"./utils-ryREhF4q.js";import"./index-McPXHFKR.js";import"./preload-helper-PPVm8Dsz.js";const v=y("text-small flex items-center font-sans",{variants:{size:{sm:"text-label gap-1.5",default:"text-small gap-2",lg:"text-body gap-2.5"}},defaultVariants:{size:"default"}}),C=y("focus-visible:ring-sunflower inline-flex items-center transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none",{variants:{isCurrentPage:{true:"text-primary cursor-default font-medium",false:"text-secondary hover:text-primary"}},defaultVariants:{isCurrentPage:!1}}),s=n.forwardRef(({className:a,size:c,separator:m=e.jsx(o,{}),children:t,...I},x)=>{const j=n.Children.toArray(t).filter(n.isValidElement);return e.jsx("nav",{ref:x,"aria-label":"Breadcrumb",...I,children:e.jsx("ol",{className:B(v({size:c,className:a})),children:j.map((S,P)=>e.jsxs("li",{className:"inline-flex items-center gap-2",children:[S,P<j.length-1&&m]},P))})})});s.displayName="Breadcrumbs";const r=n.forwardRef(({className:a,asChild:c=!1,isCurrentPage:m=!1,...t},I)=>{if(m)return e.jsx("span",{className:B(C({isCurrentPage:!0,className:a})),"aria-current":"page",children:t.children});const x=c?w:"a";return e.jsx(x,{ref:I,className:B(C({isCurrentPage:!1,className:a})),...t})});r.displayName="BreadcrumbItem";const o=n.forwardRef(({className:a,children:c,...m},t)=>e.jsx("span",{ref:t,role:"presentation","aria-hidden":"true",className:B("text-tertiary",a),...m,children:c??e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg",className:"h-4 w-4",children:e.jsx("path",{d:"M6 12L10 8L6 4",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})})}));o.displayName="BreadcrumbSeparator";s.__docgenInfo={description:`Breadcrumbs navigation component following Engrate brand guidelines.
