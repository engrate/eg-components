import{j as e}from"./jsx-runtime-u17CrQMm.js";import{S as L}from"./index-BJfhS3PZ.js";import{c as P}from"./index-HTk8j2sO.js";import{r as C}from"./iframe-8ZjGW1bL.js";import{c as M}from"./utils-kmX6UHYG.js";import"./index-0XSAmNhF.js";import"./preload-helper-PPVm8Dsz.js";const V=P("focus-visible:ring-sunflower inline-flex items-center justify-center font-sans font-normal whitespace-nowrap transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none",{variants:{variant:{sunflower:"bg-sunflower text-primary","lemon-meringue":"bg-lemon-meringue text-primary border-tertiary border",vanilla:"bg-vanilla text-primary border-tertiary border",eggshell:"bg-eggshell text-primary border-tertiary border","warm-purple":"bg-warm-purple text-white","cool-purple":"bg-cool-purple text-white","electric-blue":"bg-electric-blue text-white","deep-blue":"bg-deep-blue text-white",error:"bg-error text-white",secondary:"border-border bg-alt text-secondary border"},size:{sm:"rounded-pill px-2 py-0.5 text-xs",md:"rounded-pill px-2.5 py-1 text-xs",lg:"rounded-pill text-body px-3.5 py-1 text-sm",xl:"rounded-pill text-body px-4 py-1.5 text-xl"}},defaultVariants:{variant:"sunflower",size:"md"}}),r=C.forwardRef(({className:b,variant:S,size:w,asChild:y=!1,...E},z)=>{const j=y?L:"span";return e.jsx(j,{className:M(V({variant:S,size:w,className:b})),ref:z,...E})});r.displayName="Badge";r.__docgenInfo={description:`Badge component for displaying status, labels, or counts.
