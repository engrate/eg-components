import{j as e}from"./jsx-runtime-u17CrQMm.js";import{T as a}from"./Text-BTUOquIm.js";import"./index-Cdk5K0R8.js";import"./iframe-CxDdGAMt.js";import"./preload-helper-PPVm8Dsz.js";import"./index-COYlJ3le.js";import"./index-HTk8j2sO.js";import"./utils-kmX6UHYG.js";const k={title:"Typography/Text",component:a,parameters:{layout:"padded"},tags:["autodocs"],argTypes:{variant:{control:"select",options:["lead","semi-lead","body-lg","body","body-sm","descriptive","label","label-sm"],description:"The visual style variant of the text"},weight:{control:"select",options:["regular","medium"],description:"Font weight (medium only for emphasis in lead/semi-lead)"},as:{control:"select",options:["p","span","div","label"],description:"The HTML element to render"},asChild:{control:"boolean",description:"Render as a child element using Radix Slot"}}},r={args:{children:"The quick brown fox jumps over the lazy dog. This is standard body text used for most content throughout the application.",variant:"body"}},t={args:{children:"Lead text is used for introductory paragraphs and important statements that need extra emphasis.",variant:"lead"}},n={args:{children:"Lead text with medium weight for additional emphasis on key messages.",variant:"lead",weight:"medium"}},s={args:{children:"Semi-lead text bridges the gap between lead and body text, perfect for secondary introductions.",variant:"semi-lead"}},o={args:{children:"Large body text provides more prominence than standard body text while remaining readable for longer content.",variant:"body-lg"}},i={args:{children:"Small body text is slightly smaller than standard body text, useful for secondary content.",variant:"body-sm"}},d={args:{children:"Body text is the default text style used for paragraphs and general content throughout the application.",variant:"body"}},l={args:{children:"Descriptive text is smaller and used for supplementary information, captions, and metadata.",variant:"descriptive"}},c={args:{children:"Form Label",variant:"label"}},m={args:{children:"SMALL LABEL",variant:"label-sm"}},p={render:()=>e.jsxs("div",{className:"space-y-6",children:[e.jsx(a,{variant:"lead",children:"Lead — Primary introductory text"}),e.jsx(a,{variant:"semi-lead",children:"Semi-lead — Secondary introductory text"}),e.jsx(a,{variant:"body-lg",children:"Body Large — Emphasized body text"}),e.jsx(a,{variant:"body",children:"Body — Standard paragraph text"}),e.jsx(a,{variant:"body-sm",children:"Body Small — Slightly smaller body text"}),e.jsx(a,{variant:"descriptive",children:"Descriptive — Captions and metadata"}),e.jsx(a,{variant:"label",children:"Label — Form labels and small headings"}),e.jsx(a,{variant:"label-sm",children:"LABEL SMALL — TINY LABELS"})]})},b={render:()=>e.jsxs("div",{className:"max-w-2xl space-y-8",children:[e.jsxs("div",{className:"border-border border-b pb-4",children:[e.jsx(a,{variant:"label",className:"mb-2",children:"Lead — Work Sans, 20pt, -2% tracking, Primary color"}),e.jsx(a,{variant:"lead",children:"Engrate is revolutionizing the way we think about sustainable energy solutions for homes and businesses across the nation."})]}),e.jsxs("div",{className:"border-border border-b pb-4",children:[e.jsx(a,{variant:"label",className:"mb-2",children:"Lead (Medium) — Work Sans, 20pt, -2% tracking, Medium weight"}),e.jsx(a,{variant:"lead",weight:"medium",children:"Key message with emphasis for important announcements."})]}),e.jsxs("div",{className:"border-border border-b pb-4",children:[e.jsx(a,{variant:"label",className:"mb-2",children:"Semi-Lead — Work Sans, 15pt, 0% tracking, Secondary color"}),e.jsx(a,{variant:"semi-lead",children:"Our team of experts works closely with you to design and install the perfect solar solution for your needs."})]}),e.jsxs("div",{className:"border-border border-b pb-4",children:[e.jsx(a,{variant:"label",className:"mb-2",children:"Body Large — Work Sans, 18pt, -5% tracking, Secondary color"}),e.jsx(a,{variant:"body-lg",children:"Large body text for content that needs more prominence than standard body text while remaining comfortable for reading."})]}),e.jsxs("div",{className:"border-border border-b pb-4",children:[e.jsx(a,{variant:"label",className:"mb-2",children:"Body — Work Sans, 16pt, -5% tracking, Secondary color"}),e.jsx(a,{variant:"body",children:"Standard body text for general content. This is the most commonly used text style throughout the application and should be used for paragraphs, descriptions, and most written content."})]}),e.jsxs("div",{className:"border-border border-b pb-4",children:[e.jsx(a,{variant:"label",className:"mb-2",children:"Body Small — Work Sans, 14pt, -5% tracking, Secondary color"}),e.jsx(a,{variant:"body-sm",children:"Small body text for secondary content, side notes, and supplementary information that doesn't need full body prominence."})]}),e.jsxs("div",{className:"border-border border-b pb-4",children:[e.jsx(a,{variant:"label",className:"mb-2",children:"Descriptive — Work Sans, 12pt, +4% tracking, Secondary color"}),e.jsx(a,{variant:"descriptive",children:"Photo credit: Solar installation at Johnson residence, completed March 2024. All rights reserved."})]}),e.jsxs("div",{className:"border-border border-b pb-4",children:[e.jsx(a,{variant:"label",className:"mb-2",children:"Label — Work Sans, 12pt, +2% tracking, Tertiary color"}),e.jsx(a,{variant:"label",children:"Email Address"})]}),e.jsxs("div",{className:"border-border border-b pb-4",children:[e.jsx(a,{variant:"label",className:"mb-2",children:"Label Small — Work Sans, 10pt, +14% tracking, Tertiary color"}),e.jsx(a,{variant:"label-sm",children:"CATEGORY TAG"})]})]})},h={render:()=>e.jsxs(a,{variant:"body",children:["This is a paragraph with"," ",e.jsx(a,{variant:"lead",weight:"medium",as:"span",children:"emphasized inline text"})," ","in the middle of it."]})},x={render:()=>e.jsx(a,{variant:"body",asChild:!0,children:e.jsx("a",{href:"#example",className:"hover:text-primary underline",children:"This entire text is a clickable link"})})};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
  ...
  args: {
    children: 'Large body text provides more prominence than standard body text while remaining readable for longer content.',
    variant: 'body-lg'
  }
}`,...o.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  args: {
    children: 'Small body text is slightly smaller than standard body text, useful for secondary content.',
    variant: 'body-sm'
  }
...
}`,...x.parameters?.docs?.source}}};const j=["Default","Lead","LeadWithEmphasis","SemiLead","BodyLarge","BodySmall","Body","Descriptive","Label","LabelSmall","AllVariants","TypographyScale","AsSpan","AsLink"];export{p as AllVariants,x as AsLink,h as AsSpan,d as Body,o as BodyLarge,i as BodySmall,r as Default,l as Descriptive,c as Label,m as LabelSmall,t as Lead,n as LeadWithEmphasis,s as SemiLead,b as TypographyScale,j as __namedExportsOrder,k as default};
