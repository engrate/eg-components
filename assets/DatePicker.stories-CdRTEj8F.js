import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as s}from"./iframe--B_gcy8p.js";import{R as F,T as Y,C as O,P as R,a as _}from"./index-Cf0V0s4B.js";import{c as z}from"./index-HTk8j2sO.js";import{C as A}from"./Calendar-b34QKohK.js";import{c as i}from"./utils-kmX6UHYG.js";import"./preload-helper-PPVm8Dsz.js";import"./createLucideIcon-BPAHT39Y.js";import"./index-Rixoun3M.js";import"./index-B24crmPe.js";import"./index-C8Pcks7k.js";import"./index-VXKBYAdF.js";import"./index-BKASW534.js";import"./index-BiA2yjU3.js";import"./index-DG2NQ2mn.js";import"./index-BihYKWtj.js";import"./index-D78PEP2Q.js";import"./index-B1jEWZq4.js";import"./index-eNHV4T1v.js";import"./chevron-right-C-xnsn-Y.js";function S(t,a="yyyy-MM-dd"){if(!t)return"";const l=String(t.getMonth()+1).padStart(2,"0"),d=String(t.getDate()).padStart(2,"0"),o=t.getFullYear();return a.replace("yyyy",String(o)).replace("MM",l).replace("dd",d)}const I=z(["bg-card text-body-sm text-primary placeholder:text-tertiary","flex h-8 w-full items-center justify-between rounded-md border px-3 py-1","font-sans transition-colors","focus-visible:ring-sunflower focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none","disabled:cursor-not-allowed disabled:opacity-50"],{variants:{variant:{default:"border-border",error:"border-error"}},defaultVariants:{variant:"default"}}),r=s.forwardRef(({value:t,onChange:a,placeholder:l="Select a date",format:d="MM/dd/yyyy",minDate:o,maxDate:b,disabled:N=!1,variant:M,className:w,id:C,name:v,"aria-label":k,"aria-describedby":T},E)=>{const[D,g]=s.useState(!1),[P,j]=s.useState(t||new Date),V=s.useMemo(()=>{const n=[];return o&&n.push({before:o}),b&&n.push({after:b}),n.length>0?n:void 0},[o,b]),q=n=>{a?.(n??null),n&&g(!1)},W=()=>{a?.(new Date),g(!1)};return s.useEffect(()=>{t&&j(t)},[t]),e.jsxs(F,{open:D,onOpenChange:g,children:[e.jsx(Y,{asChild:!0,children:e.jsxs("button",{ref:E,id:C,type:"button",disabled:N,className:i(I({variant:M}),w),"aria-label":k||"Choose date","aria-describedby":T,"aria-haspopup":"dialog","aria-expanded":D,children:[e.jsx("span",{className:i("truncate",!t&&"text-tertiary"),children:t?S(t,d):l}),e.jsx(O,{className:"text-tertiary h-4 w-4 shrink-0"}),v&&e.jsx("input",{type:"hidden",name:v,value:t?S(t,"yyyy-MM-dd"):""})]})}),e.jsx(R,{children:e.jsxs(_,{className:i("bg-main border-border z-50 w-auto rounded-lg border p-4 shadow-lg","data-[state=open]:animate-in data-[state=closed]:animate-out","data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0","data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95","data-[side=bottom]:slide-in-from-top-2","data-[side=top]:slide-in-from-bottom-2"),sideOffset:4,align:"start",children:[e.jsx(A,{mode:"single",selected:t??void 0,onSelect:q,month:P,onMonthChange:j,disabled:V}),e.jsx("div",{className:"border-border mt-4 border-t pt-4",children:e.jsx("button",{type:"button",onClick:W,className:i("text-sunflower hover:text-sunflower-hover w-full text-center text-sm font-medium","transition-colors focus-visible:underline focus-visible:outline-none"),children:"Today"})})]})})]})});r.displayName="DatePicker";r.__docgenInfo={description:`DatePicker component following Engrate brand guidelines.
...
}`,...y.parameters?.docs?.source}}};const xe=["Default","WithValue","Error","Disabled","CustomFormat","WithMinMaxDate","Controlled","AllStates"];export{y as AllStates,f as Controlled,x as CustomFormat,c as Default,u as Disabled,p as Error,h as WithMinMaxDate,m as WithValue,xe as __namedExportsOrder,ue as default};
