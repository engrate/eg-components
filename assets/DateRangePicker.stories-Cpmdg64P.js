import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as n}from"./iframe-DsbWSdmo.js";import{R as O,T as $,P as _,C as z}from"./index-qNrQNO7u.js";import{c as A}from"./index-HTk8j2sO.js";import{C as L}from"./Calendar-VEO-3Zsn.js";import{c as d}from"./utils-kmX6UHYG.js";import{C as I}from"./calendar-U2P42ZGE.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DyYZAHtc.js";import"./index-DNAIuZ4U.js";import"./index-C4ecdTz-.js";import"./index-DJhPqag_.js";import"./index-CHV1Qs9S.js";import"./index-C7qyGbRY.js";import"./index-Chp6Wfa5.js";import"./index-Dxjhj1kq.js";import"./index-DOkQJ0Ai.js";import"./index-CaD20gaj.js";import"./index-gZERSfW6.js";import"./chevron-left-C-O-zlKb.js";import"./createLucideIcon-DnL5f5sr.js";import"./chevron-right-DAl41zNs.js";function y(t,a="yyyy-MM-dd"){if(!t)return"";const r=String(t.getMonth()+1).padStart(2,"0"),o=String(t.getDate()).padStart(2,"0"),i=t.getFullYear();return a.replace("yyyy",String(i)).replace("MM",r).replace("dd",o)}function B(t,a){if(!t?.from)return"";const r=y(t.from,a);if(!t.to)return`${r} – ...`;const o=y(t.to,a);return`${r} – ${o}`}const G=A(["text-body-sm text-primary placeholder:text-quaternary bg-white","flex w-full items-center justify-between rounded-md border px-3 py-2","font-sans transition-colors","focus-visible:ring-sunflower focus-visible:ring-1 focus-visible:outline-none","disabled:cursor-not-allowed disabled:opacity-50"],{variants:{variant:{default:"border-border",error:"border-error"}},defaultVariants:{variant:"default"}}),s=n.forwardRef(({value:t,onChange:a,placeholder:r="Select date range",format:o="MM/dd/yyyy",minDate:i,maxDate:v,disabled:M=!1,numberOfMonths:w=2,variant:N,className:C,id:R,name:D,"aria-label":k,"aria-describedby":T},E)=>{const[S,P]=n.useState(!1),[q,j]=n.useState(t?.from||new Date),V=n.useMemo(()=>{const l=[];return i&&l.push({before:i}),v&&l.push({after:v}),l.length>0?l:void 0},[i,v]),W=l=>{a?.(l)},Y=()=>{const l=new Date;a?.({from:l,to:l})},F=()=>{a?.(void 0)};return n.useEffect(()=>{t?.from&&j(t.from)},[t?.from]),e.jsxs(O,{open:S,onOpenChange:P,children:[e.jsx($,{asChild:!0,children:e.jsxs("button",{ref:E,id:R,type:"button",disabled:M,className:d(G({variant:N}),C),"aria-label":k||"Choose date range","aria-describedby":T,"aria-haspopup":"dialog","aria-expanded":S,children:[e.jsx("span",{className:d("truncate",!t?.from&&"text-quaternary"),children:t?.from?B(t,o):r}),e.jsx(I,{className:"text-tertiary h-4 w-4 shrink-0"}),D&&e.jsx("input",{type:"hidden",name:D,value:t?.from?`${y(t.from,"yyyy-MM-dd")}/${y(t.to,"yyyy-MM-dd")}`:""})]})}),e.jsx(_,{children:e.jsxs(z,{className:d("border-border z-50 w-auto rounded-lg border bg-white p-4 shadow-lg","data-[state=open]:animate-in data-[state=closed]:animate-out","data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0","data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95","data-[side=bottom]:slide-in-from-top-2","data-[side=top]:slide-in-from-bottom-2"),sideOffset:4,align:"start",children:[e.jsx(L,{mode:"range",selected:t,onSelect:W,month:q,onMonthChange:j,numberOfMonths:w,disabled:V}),e.jsxs("div",{className:"border-border mt-4 flex items-center justify-between border-t pt-4",children:[e.jsx("button",{type:"button",onClick:F,className:d("text-tertiary hover:text-secondary text-small","transition-colors focus-visible:underline focus-visible:outline-none"),children:"Clear"}),e.jsx("button",{type:"button",onClick:Y,className:d("text-sunflower hover:text-sunflower-hover text-small","transition-colors focus-visible:underline focus-visible:outline-none"),children:"Today"})]})]})})]})});s.displayName="DateRangePicker";s.__docgenInfo={description:`DateRangePicker component following Engrate brand guidelines.
...
}`,...b.parameters?.docs?.source}}};const De=["Default","WithValue","Error","Disabled","CustomFormat","WithMinMaxDate","Controlled","SingleMonth","AllStates"];export{b as AllStates,x as Controlled,g as CustomFormat,c as Default,u as Disabled,p as Error,h as SingleMonth,f as WithMinMaxDate,m as WithValue,De as __namedExportsOrder,ve as default};
