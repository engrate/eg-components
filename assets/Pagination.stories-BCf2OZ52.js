import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as N}from"./iframe-DNYoVwFJ.js";import{c as _}from"./index-DDA3KdpW.js";import{c as L}from"./utils-ryREhF4q.js";import{C as q,a as D}from"./chevron-right-Bs7HbCAt.js";import{E as G}from"./ellipsis-paKColQz.js";import"./preload-helper-PPVm8Dsz.js";import"./createLucideIcon-DRgqOcQt.js";const W=_("flex items-center justify-center gap-1 font-sans",{variants:{size:{sm:"text-small",default:"text-body",lg:"text-lead"}},defaultVariants:{size:"default"}}),B=_("focus-visible:ring-sunflower inline-flex items-center justify-center font-sans font-normal transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50",{variants:{variant:{default:"text-primary hover:bg-alt active:bg-contrast rounded-full",active:"bg-sunflower text-primary hover:bg-sunflower-hover rounded-full",ellipsis:"text-tertiary cursor-default"},size:{sm:"text-small h-7 w-7",default:"text-small h-9 w-9",lg:"text-body h-11 w-11"}},defaultVariants:{variant:"default",size:"default"}}),n=N.forwardRef(({className:l,size:r,page:a,totalPages:t,onPageChange:S,siblingCount:o=1,...E},M)=>{const A=N.useMemo(()=>{const V=o*2+3+2;if(t<=V)return Array.from({length:t},(i,c)=>c+1);const R=Math.max(a-o,1),k=Math.min(a+o,t),C=R>2,z=k<t-1;if(!C&&z){const i=3+2*o;return[...Array.from({length:i},(I,T)=>T+1),"ellipsis-right",t]}if(C&&!z){const i=3+2*o;return[1,"ellipsis-left",...Array.from({length:i},(I,T)=>t-i+T+1)]}return C&&z?[1,"ellipsis-left",...Array.from({length:o*2+1},(c,I)=>R+I),"ellipsis-right",t]:Array.from({length:t},(i,c)=>c+1)},[a,t,o]),w=s=>{s>=1&&s<=t&&s!==a&&S?.(s)};return e.jsxs("nav",{ref:M,role:"navigation","aria-label":"Pagination",className:L(W({size:r,className:l})),...E,children:[e.jsx(g,{size:r,onClick:()=>w(a-1),disabled:a===1,"aria-label":"Go to previous page",children:e.jsx(q,{className:"h-4 w-4"})}),A.map(s=>typeof s=="string"?e.jsx(g,{size:r,variant:"ellipsis",disabled:!0,"aria-hidden":!0,children:e.jsx(G,{className:"h-4 w-4"})},s):e.jsx(g,{size:r,variant:s===a?"active":"default",onClick:()=>w(s),"aria-label":`Go to page ${s}`,"aria-current":s===a?"page":void 0,children:s},s)),e.jsx(g,{size:r,onClick:()=>w(a+1),disabled:a===t,"aria-label":"Go to next page",children:e.jsx(D,{className:"h-4 w-4"})})]})});n.displayName="Pagination";const g=N.forwardRef(({className:l,variant:r,size:a,...t},S)=>e.jsx("button",{ref:S,type:"button",className:L(B({variant:r,size:a,className:l})),...t}));g.displayName="PaginationItem";n.__docgenInfo={description:`Navigation component for paginated content.
