import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as a}from"./iframe-C8eljAvV.js";import{c as J,a as Q}from"./index-B5w_ep6V.js";import{u as P}from"./index-pMVG9LbY.js";import{R as U,T as X,c as E,P as Z,W as ee,C as te,a as ne,D as ie,b as I,O as re}from"./index-BvzZpKMr.js";import{c as le}from"./index-DDA3KdpW.js";import{c as x}from"./utils-ryREhF4q.js";import{b as O,B as p}from"./Button-KQFuaT1T.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BTWBGoHW.js";import"./index-BNj1C9jx.js";import"./index-BmWG54AT.js";import"./index-BE3kAVMH.js";import"./index-D3u4m6iL.js";import"./index-DzKWrijt.js";import"./index-HFw1Nw13.js";import"./index-D413khBD.js";var ae=Symbol("radix.slottable");function oe(n){const t=({children:i})=>e.jsx(e.Fragment,{children:i});return t.displayName=`${n}.Slottable`,t.__radixId=ae,t}var F="AlertDialog",[se]=Q(F,[E]),A=E(),B=n=>{const{__scopeAlertDialog:t,...i}=n,r=A(t);return e.jsx(U,{...r,...i,modal:!0})};B.displayName=F;var ce="AlertDialogTrigger",L=a.forwardRef((n,t)=>{const{__scopeAlertDialog:i,...r}=n,l=A(i);return e.jsx(X,{...l,...r,ref:t})});L.displayName=ce;var de="AlertDialogPortal",H=n=>{const{__scopeAlertDialog:t,...i}=n,r=A(t);return e.jsx(Z,{...r,...i})};H.displayName=de;var ue="AlertDialogOverlay",z=a.forwardRef((n,t)=>{const{__scopeAlertDialog:i,...r}=n,l=A(i);return e.jsx(re,{...l,...r,ref:t})});z.displayName=ue;var f="AlertDialogContent",[ge,me]=se(f),De=oe("AlertDialogContent"),V=a.forwardRef((n,t)=>{const{__scopeAlertDialog:i,children:r,...l}=n,_=A(i),j=a.useRef(null),K=P(t,j),R=a.useRef(null);return e.jsx(ee,{contentName:f,titleName:$,docsSlug:"alert-dialog",children:e.jsx(ge,{scope:i,cancelRef:R,children:e.jsxs(te,{role:"alertdialog",..._,...l,ref:K,onOpenAutoFocus:J(l.onOpenAutoFocus,v=>{v.preventDefault(),R.current?.focus({preventScroll:!0})}),onPointerDownOutside:v=>v.preventDefault(),onInteractOutside:v=>v.preventDefault(),children:[e.jsx(De,{children:r}),e.jsx(pe,{contentRef:j})]})})})});V.displayName=f;var $="AlertDialogTitle",M=a.forwardRef((n,t)=>{const{__scopeAlertDialog:i,...r}=n,l=A(i);return e.jsx(ne,{...l,...r,ref:t})});M.displayName=$;var Y="AlertDialogDescription",q=a.forwardRef((n,t)=>{const{__scopeAlertDialog:i,...r}=n,l=A(i);return e.jsx(ie,{...l,...r,ref:t})});q.displayName=Y;var Ae="AlertDialogAction",k=a.forwardRef((n,t)=>{const{__scopeAlertDialog:i,...r}=n,l=A(i);return e.jsx(I,{...l,...r,ref:t})});k.displayName=Ae;var G="AlertDialogCancel",W=a.forwardRef((n,t)=>{const{__scopeAlertDialog:i,...r}=n,{cancelRef:l}=me(G,i),_=A(i),j=P(t,l);return e.jsx(I,{..._,...r,ref:j})});W.displayName=G;var pe=({contentRef:n})=>{const t=`\`${f}\` requires a description for the component to be accessible for screen reader users.
