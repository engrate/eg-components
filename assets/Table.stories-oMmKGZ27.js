import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as c}from"./iframe-O2QU597t.js";import{c as f}from"./index-DDA3KdpW.js";import{c as C}from"./utils-ryREhF4q.js";import{I as P}from"./Input-DCJfvarv.js";import"./preload-helper-PPVm8Dsz.js";const K=f("text-body w-full caption-bottom border-collapse font-sans",{variants:{variant:{default:"border-separate border-spacing-0",striped:"border-separate border-spacing-0"},size:{default:"",compact:""}},defaultVariants:{variant:"default",size:"default"}}),_=f("border-border bg-alt border-b",{variants:{},defaultVariants:{}}),z=f("",{variants:{},defaultVariants:{}}),O=f("transition-colors",{variants:{variant:{default:"border-border hover:bg-alt/50 border-b",striped:"border-border even:bg-alt/30 hover:bg-alt border-b"}},defaultVariants:{variant:"default"}}),M=f("text-small text-primary text-left align-middle font-sans font-normal [&:has([role=checkbox])]:pr-0",{variants:{sortable:{true:"hover:bg-contrast cursor-pointer select-none",false:""},size:{default:"h-12 px-4",compact:"h-8 px-2"}},defaultVariants:{sortable:!1,size:"default"}}),q=f("text-secondary align-middle [&:has([role=checkbox])]:pr-0",{variants:{size:{default:"p-4",compact:"p-2"}},defaultVariants:{size:"default"}}),W=c.createContext({size:"default"}),T=c.forwardRef(({className:s,variant:t,size:r="default",...i},o)=>e.jsx(W.Provider,{value:{size:r??"default"},children:e.jsx("div",{className:"relative w-full overflow-auto",children:e.jsx("table",{ref:o,className:C(K({variant:t,size:r}),s),...i})})}));T.displayName="Table";const x=c.forwardRef(({className:s,...t},r)=>e.jsx("thead",{ref:r,className:C(_(),s),...t}));x.displayName="TableHeader";const p=c.forwardRef(({className:s,...t},r)=>e.jsx("tbody",{ref:r,className:C(z(),s),...t}));p.displayName="TableBody";const I=c.forwardRef(({className:s,...t},r)=>e.jsx("tfoot",{ref:r,className:C("border-border bg-alt text-primary border-t font-normal",s),...t}));I.displayName="TableFooter";const a=c.forwardRef(({className:s,variant:t,...r},i)=>e.jsx("tr",{ref:i,className:C(O({variant:t}),s),...r}));a.displayName="TableRow";const n=c.forwardRef(({className:s,children:t,sortable:r=!1,sortDirection:i=null,onSort:o,...d},h)=>{const{size:m}=c.useContext(W),b=()=>{r&&o&&o()},g=j=>{r&&o&&(j.key==="Enter"||j.key===" ")&&(j.preventDefault(),o())};return e.jsx("th",{ref:h,className:C(M({sortable:r,size:m}),s),onClick:b,onKeyDown:g,tabIndex:r?0:void 0,role:r?"button":void 0,"aria-sort":i==="asc"?"ascending":i==="desc"?"descending":void 0,...d,children:e.jsxs("div",{className:"flex items-center gap-2",children:[t,r&&e.jsxs("span",{className:"inline-flex flex-col","aria-hidden":"true",children:[e.jsx("svg",{className:C("h-3 w-3 transition-opacity",i==="asc"?"opacity-100":"opacity-30"),fill:"none",stroke:"currentColor",strokeWidth:"2",viewBox:"0 0 24 24",children:e.jsx("path",{d:"M7 15l5-5 5 5"})}),e.jsx("svg",{className:C("-mt-1 h-3 w-3 transition-opacity",i==="desc"?"opacity-100":"opacity-30"),fill:"none",stroke:"currentColor",strokeWidth:"2",viewBox:"0 0 24 24",children:e.jsx("path",{d:"M7 9l5 5 5-5"})})]})]})})});n.displayName="TableHead";const l=c.forwardRef(({className:s,...t},r)=>{const{size:i}=c.useContext(W);return e.jsx("td",{ref:r,className:C(q({size:i}),s),...t})});l.displayName="TableCell";const y=c.forwardRef(({className:s,...t},r)=>e.jsx("caption",{ref:r,className:C("text-small text-tertiary mt-4",s),...t}));y.displayName="TableCaption";function L({data:s,initialSortKey:t=null,initialSortDirection:r="asc"}){const[i,o]=c.useState(t),[d,h]=c.useState(r),m=c.useCallback(g=>{o(j=>j===g?(h(u=>u==="asc"?"desc":u==="desc"?(o(null),null):"asc"),j):(h("asc"),g))},[]);return{sortedData:c.useMemo(()=>!i||!d?s:[...s].sort((g,j)=>{const u=g[i],w=j[i];if(u===w)return 0;let S=0;return typeof u=="string"&&typeof w=="string"?S=u.localeCompare(w):typeof u=="number"&&typeof w=="number"?S=u-w:S=String(u).localeCompare(String(w)),d==="asc"?S:-S}),[s,i,d]),sortKey:i,sortDirection:d,handleSort:m}}function $({data:s,filterKeys:t}){const[r,i]=c.useState("");return{filteredData:c.useMemo(()=>{if(!r.trim())return s;const d=r.toLowerCase();return s.filter(h=>t&&t.length>0?t.some(m=>String(h[m]).toLowerCase().includes(d)):Object.values(h).some(m=>String(m).toLowerCase().includes(d)))},[s,r,t]),filterValue:r,setFilterValue:i}}T.__docgenInfo={description:`Table root component following Engrate brand guidelines.
