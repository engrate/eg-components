import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as o}from"./iframe-BHo53yX8.js";import{c as f}from"./index-HTk8j2sO.js";import{c as h}from"./utils-kmX6UHYG.js";import"./preload-helper-PPVm8Dsz.js";const D=o.createContext(null);function P(){const n=o.useContext(D);if(!n)throw new Error("PaginationDot must be used within a PaginationDots component");return n}const j=f("inline-flex items-center justify-center font-sans",{variants:{size:{sm:"gap-1.5",default:"gap-2",lg:"gap-2.5"}},defaultVariants:{size:"default"}}),r=o.forwardRef(({className:n,value:a,onValueChange:s,size:l="default",children:i,...c},v)=>e.jsx(D.Provider,{value:{value:a,onValueChange:s,size:l??"default"},children:e.jsx("div",{ref:v,role:"group","aria-label":"Content navigation",className:h(j({size:l}),n),...c,children:i})}));r.displayName="PaginationDots";const y=f("focus-visible:ring-sunflower rounded-full transition-all duration-300 ease-out focus-visible:ring-1 focus-visible:outline-none",{variants:{size:{sm:"h-1.5",default:"h-2",lg:"h-2.5"},active:{true:"bg-sunflower",false:"bg-border hover:bg-quaternary"}},compoundVariants:[{size:"sm",active:!1,class:"w-1.5"},{size:"default",active:!1,class:"w-2"},{size:"lg",active:!1,class:"w-2.5"},{size:"sm",active:!0,class:"w-4"},{size:"default",active:!0,class:"w-6"},{size:"lg",active:!0,class:"w-8"}],defaultVariants:{size:"default",active:!1}}),t=o.forwardRef(({className:n,index:a,...s},l)=>{const{value:i,onValueChange:c,size:v}=P(),p=a===i;return e.jsx("button",{ref:l,type:"button","aria-label":`Go to slide ${a+1}`,"aria-current":p?"true":void 0,onClick:()=>c?.(a),className:h(y({size:v,active:p}),n),...s})});t.displayName="PaginationDot";r.__docgenInfo={description:`A dot indicator for switching between content panels (e.g. carousels).
