import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as m}from"./iframe-Bjj-UmeF.js";import{c as h}from"./index-HTk8j2sO.js";import{c as u}from"./utils-kmX6UHYG.js";import{C as O}from"./check-Cne1yD2X.js";import"./preload-helper-PPVm8Dsz.js";import"./createLucideIcon-DonwwONn.js";const U=m.createContext(null);function W(){const t=m.useContext(U);if(!t)throw new Error("Stepper components must be used within a Stepper");return t}const $=m.createContext(null);function T(){const t=m.useContext($);if(!t)throw new Error("StepperItem child components must be used within a StepperItem");return t}const Q=h("flex",{variants:{orientation:{horizontal:"flex-row items-start",vertical:"flex-col"}},defaultVariants:{orientation:"horizontal"}}),X=h("inline-flex items-center font-sans",{variants:{size:{sm:"gap-1",default:"gap-1.5",lg:"gap-2"}},defaultVariants:{size:"default"}}),Z=h("inline-flex shrink-0 items-center justify-center rounded-full transition-colors",{variants:{size:{sm:"h-5 w-5 text-[10px]",default:"h-6 w-6 text-[11px]",lg:"h-7 w-7 text-xs"}},defaultVariants:{size:"default"}}),ee=h("transition-colors",{variants:{size:{sm:"h-0.5 w-3",default:"h-0.5 w-4",lg:"h-0.5 w-5"}},defaultVariants:{size:"default"}}),c=m.forwardRef(({className:t,variant:r="default",activeStep:i=1,orientation:a="horizontal",totalSteps:x,size:d,labels:y,onStepClick:b,children:I,...j},w)=>{const[f,E]=m.useState(0),G=m.useMemo(()=>({activeStep:i,orientation:a,totalSteps:f,setTotalSteps:E}),[i,a,f]);if(r==="mini"){const F=x??0,H=Array.from({length:F},(v,g)=>g+1);return e.jsx("div",{ref:w,role:"group","aria-label":"Progress",className:u(X({size:d}),t),...j,children:H.map(v=>{const g=v<i?"completed":v===i?"active":"inactive",J=y?.[v-1]??`Step ${v}`,K=v===F;return e.jsxs(m.Fragment,{children:[e.jsx("button",{type:"button","aria-current":g==="active"?"step":void 0,"aria-label":J,"data-state":g,disabled:!b,onClick:()=>b?.(v),className:u(Z({size:d}),"focus-visible:ring-sunflower focus-visible:ring-1 focus-visible:outline-none",b?"cursor-pointer":"cursor-default disabled:opacity-100",g==="completed"&&"bg-sunflower text-primary",g==="active"&&"border-sunflower text-primary border-2",g==="inactive"&&"border-border text-tertiary border-2"),children:g==="completed"?e.jsx(O,{className:u(d==="sm"&&"h-2.5 w-2.5",d==="lg"&&"h-3.5 w-3.5",(!d||d==="default")&&"h-3 w-3"),strokeWidth:3}):v}),!K&&e.jsx("div",{"aria-hidden":"true",className:u(ee({size:d}),v<i?"bg-sunflower":"bg-border")})]},v)})})}return e.jsx(U.Provider,{value:G,children:e.jsxs("div",{ref:w,role:"group","aria-label":"Progress","data-orientation":a,className:u("w-full",t),...j,children:[e.jsx("div",{className:u(Q({orientation:a})),children:I}),a==="horizontal"&&f>0&&e.jsxs("div",{className:"text-tertiary text-body-sm mt-4 text-center font-sans",children:["Step ",Math.min(i,f)," of ",f]})]})})});c.displayName="Stepper";const te=h("group relative",{variants:{orientation:{horizontal:"flex flex-1 flex-col items-center",vertical:"flex flex-col"}},defaultVariants:{orientation:"horizontal"}}),n=m.forwardRef(({className:t,step:r,children:i,...a},x)=>{const{activeStep:d,orientation:y,totalSteps:b,setTotalSteps:I}=W(),j=r<d?"completed":r===d?"active":"inactive";m.useEffect(()=>{I(E=>Math.max(E,r))},[r,I]);const w=r===b,f=m.useMemo(()=>({step:r,state:j,isLastStep:w}),[r,j,w]);return e.jsx($.Provider,{value:f,children:e.jsx("div",{ref:x,"data-state":j,"data-step":r,"data-orientation":y,className:u(te({orientation:y}),t),...a,children:i})})});n.displayName="StepperItem";const re=h("focus-visible:ring-sunflower flex items-center gap-3 text-left font-sans transition-colors focus-visible:ring-1 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50",{variants:{orientation:{horizontal:"flex-col items-center gap-2 text-center",vertical:"flex-row"}},defaultVariants:{orientation:"horizontal"}}),s=m.forwardRef(({className:t,children:r,...i},a)=>{const{orientation:x}=W(),{state:d}=T();return e.jsx("button",{ref:a,type:"button","aria-current":d==="active"?"step":void 0,"data-state":d,className:u(re({orientation:x}),t),...i,children:r})});s.displayName="StepperTrigger";const ae=h("text-body-sm inline-flex shrink-0 items-center justify-center rounded-full font-sans transition-colors",{variants:{size:{sm:"h-7 w-7",default:"h-9 w-9",lg:"h-11 w-11"}},defaultVariants:{size:"default"}}),p=m.forwardRef(({className:t,size:r,children:i,...a},x)=>{const{state:d,step:y}=T();return e.jsx("span",{ref:x,"data-state":d,className:u(ae({size:r}),d==="completed"&&"bg-sunflower text-primary",d==="active"&&"border-sunflower text-primary border-2",d==="inactive"&&"border-border text-tertiary border-2",t),"aria-hidden":"true",...a,children:d==="completed"?e.jsx(O,{className:"h-4 w-4"}):i??y})});p.displayName="StepperIndicator";const o=m.forwardRef(({className:t,...r},i)=>{const{state:a}=T();return e.jsx("span",{ref:i,"data-state":a,className:u("text-body-sm font-sans font-medium tracking-tight",a==="inactive"?"text-tertiary":"text-primary",t),...r})});o.displayName="StepperTitle";const l=m.forwardRef(({className:t,...r},i)=>{const{state:a}=T();return e.jsx("p",{ref:i,"data-state":a,className:u("text-small font-sans",a==="inactive"?"text-quaternary":"text-secondary",t),...r})});l.displayName="StepperDescription";const ie=h("transition-colors",{variants:{orientation:{horizontal:"absolute top-[17px] right-[calc(-50%_+_24px)] left-[calc(50%_+_24px)] h-0.5",vertical:"mt-1 mb-1 ml-4.5 min-h-8 w-0.5"}},defaultVariants:{orientation:"horizontal"}}),S=m.forwardRef(({className:t,...r},i)=>{const{orientation:a}=W(),{state:x}=T();return e.jsx("div",{ref:i,role:"separator","data-state":x,"data-orientation":a,className:u(ie({orientation:a}),x==="completed"?"bg-sunflower":"bg-border",t),"aria-hidden":"true",...r})});S.displayName="StepperSeparator";c.__docgenInfo={description:`Root container for the stepper component.
...
}`,...L.parameters?.docs?.source}}};const Se=["Default","SecondStep","AllCompleted","Vertical","FourSteps","Interactive","Mini","MiniFirstStep","MiniAllCompleted","MiniSmall","MiniLarge","MiniWithLabels","MiniAllSizes","MiniInteractive","MiniInContext"];export{D as AllCompleted,N as Default,k as FourSteps,z as Interactive,M as Mini,P as MiniAllCompleted,q as MiniAllSizes,V as MiniFirstStep,L as MiniInContext,B as MiniInteractive,R as MiniLarge,_ as MiniSmall,Y as MiniWithLabels,C as SecondStep,A as Vertical,Se as __namedExportsOrder,me as default};
