import{j as e}from"./jsx-runtime-u17CrQMm.js";import{c as S}from"./index-DDA3KdpW.js";import{r as b}from"./iframe-Dv90unGT.js";import{c as y}from"./utils-ryREhF4q.js";import{B as g}from"./Button-DRHqskmA.js";import"./preload-helper-PPVm8Dsz.js";import"./index-mNC3-AD3.js";import"./index-McPXHFKR.js";const z=S("inline-block animate-spin rounded-full border-solid border-current border-r-transparent motion-reduce:animate-[spin_1.5s_linear_infinite]",{variants:{variant:{default:"text-sunflower",muted:"text-secondary",inverted:"text-white"},size:{sm:"h-4 w-4 border-2",default:"h-6 w-6 border-2",lg:"h-8 w-8 border-3",xl:"h-12 w-12 border-4"}},defaultVariants:{variant:"default",size:"default"}}),s=b.forwardRef(({className:f,variant:v,size:N,label:u="Loading",...h},j)=>e.jsx("span",{ref:j,role:"status","aria-label":u,className:y(z({variant:v,size:N,className:f})),...h,children:e.jsx("span",{className:"sr-only",children:u})}));s.displayName="Spinner";s.__docgenInfo={description:`Loading spinner component following Engrate brand guidelines.
