import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as d}from"./iframe-CyAOHNbs.js";import{C as m}from"./Calendar-C_yCiu5Z.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-kmX6UHYG.js";import"./chevron-left-CObA1xRg.js";import"./createLucideIcon-KHjBOLfQ.js";import"./chevron-right-BkL-EZ_3.js";function l(){const[s,a]=d.useState(new Date);return e.jsx(m,{mode:"single",selected:s,onSelect:a,className:"rounded-lg border"})}function c(){const[s,a]=d.useState({from:new Date(2025,1,10),to:new Date(2025,1,20)});return e.jsx(m,{mode:"range",selected:s,onSelect:a,className:"rounded-lg border"})}function i(){const[s,a]=d.useState(new Date);return e.jsx(m,{mode:"single",selected:s,onSelect:a,numberOfMonths:2,className:"rounded-lg border"})}const v={title:"Primitives/Calendar",component:m,parameters:{layout:"centered"},tags:["autodocs"]},t={render:()=>e.jsx(l,{})},n={render:()=>e.jsx(c,{})},r={render:()=>e.jsx(i,{})},o={render:()=>e.jsxs("div",{className:"flex flex-col gap-8",children:[e.jsxs("div",{children:[e.jsx("h3",{className:"text-small text-secondary mb-3 font-medium",children:"Single Date"}),e.jsx(l,{})]}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-small text-secondary mb-3 font-medium",children:"Date Range"}),e.jsx(c,{})]}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-small text-secondary mb-3 font-medium",children:"Two Months"}),e.jsx(i,{})]})]})};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
