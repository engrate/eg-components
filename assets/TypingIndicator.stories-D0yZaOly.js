import{j as e}from"./jsx-runtime-u17CrQMm.js";import{c as l}from"./utils-kmX6UHYG.js";import{E as c}from"./Eyebrow-DjYvseNM.js";import{m}from"./proxy-BHOW06ps.js";import"./index-DQiHrFlc.js";import"./iframe-DsbWSdmo.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DJhPqag_.js";import"./index-HTk8j2sO.js";function o({eyebrow:s,className:n,...i}){return e.jsxs("div",{className:l("w-full",n),...i,children:[s?e.jsx(c,{size:"sm",className:"text-tertiary mb-1.5 block",children:s}):null,e.jsx("div",{className:"flex items-center gap-1","aria-label":"Working",children:[0,1,2].map(r=>e.jsx(m.span,{className:"bg-tertiary h-1.5 w-1.5 rounded-full",animate:{y:[0,-4,0],opacity:[.4,1,.4]},transition:{duration:.8,repeat:1/0,delay:r*.15,ease:"easeInOut"}},r))})]})}o.__docgenInfo={description:`Three bouncing dots, no bubble. Use as a fallback indicator when the
