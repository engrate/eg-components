import{j as e}from"./jsx-runtime-u17CrQMm.js";import{S as W}from"./index-BBjSUKsi.js";import{c as C}from"./index-DDA3KdpW.js";import{r as L}from"./iframe-DZUoxlIx.js";import{c as M}from"./utils-ryREhF4q.js";import{B as v}from"./Button-txOE3y7o.js";import"./index-BSozM382.js";import"./preload-helper-PPVm8Dsz.js";const T=C("text-small relative flex w-full items-center gap-3 px-4 py-3 font-sans transition-colors",{variants:{variant:{info:"bg-electric-blue text-white",success:"bg-sunflower text-primary",warning:"bg-lemon-meringue text-primary",error:"bg-error text-white",neutral:"bg-alt text-primary border-border border"},align:{left:"justify-start text-left",center:"justify-center text-center"}},defaultVariants:{variant:"info",align:"center"}}),r=L.forwardRef(({className:g,variant:b,align:k,asChild:B=!1,icon:f,action:w,onDismiss:x,children:j,...y},N)=>{const S=B?W:"div";return e.jsxs(S,{role:"alert",className:M(T({variant:b,align:k,className:g})),ref:N,...y,children:[f&&e.jsx("span",{className:"shrink-0",children:f}),e.jsx("span",{className:"flex-1",children:j}),w&&e.jsx("span",{className:"shrink-0",children:w}),x&&e.jsx("button",{type:"button",onClick:x,className:"hover:bg-primary/10 focus-visible:ring-sunflower -mr-1 shrink-0 rounded p-1 transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none","aria-label":"Dismiss banner",children:e.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",children:[e.jsx("path",{d:"M18 6 6 18"}),e.jsx("path",{d:"m6 6 12 12"})]})})]})});r.displayName="Banner";r.__docgenInfo={description:`Banner component for displaying important messages, announcements, or alerts.
