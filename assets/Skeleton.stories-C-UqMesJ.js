import{j as e}from"./jsx-runtime-u17CrQMm.js";import{c as w}from"./index-HTk8j2sO.js";import{r as N}from"./iframe-koNkZn7R.js";import{c as S}from"./utils-kmX6UHYG.js";import{C as k}from"./Card-Dsfi0TRw.js";import"./preload-helper-PPVm8Dsz.js";import"./index-nVyBv6Jz.js";import"./index-CADF9tOx.js";const j=w("bg-contrast animate-pulse",{variants:{variant:{default:"rounded-md",circular:"rounded-full",text:"rounded"}},defaultVariants:{variant:"default"}}),a=N.forwardRef(({className:h,variant:p,width:t,height:s,style:u,...f},v)=>{const g={...u,...t!==void 0&&{width:typeof t=="number"?`${t}px`:t},...s!==void 0&&{height:typeof s=="number"?`${s}px`:s}};return e.jsx("div",{ref:v,"aria-hidden":"true",className:S(j({variant:p,className:h})),style:g,...f})});a.displayName="Skeleton";a.__docgenInfo={description:`Skeleton component for indicating loading states.
