import{j as e}from"./jsx-runtime-u17CrQMm.js";import{L as o}from"./Label-CUXa_B0a.js";import"./iframe-DsOMdu-l.js";import"./preload-helper-PPVm8Dsz.js";import"./index-C3bAx03m.js";import"./index-DRI4W-9D.js";import"./index-DcK1wo3Z.js";import"./index-eE-IUZyM.js";import"./index-DDA3KdpW.js";import"./utils-ryREhF4q.js";const h={title:"Forms/Label",component:o,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{size:{control:"select",options:["default","sm"],description:"The size of the label"},htmlFor:{control:"text",description:"The id of the form element the label is for"}}},s={args:{children:"Email address"}},r={args:{children:"Small label",size:"sm"}},a={render:()=>e.jsxs("div",{className:"flex flex-col gap-1.5",children:[e.jsx(o,{htmlFor:"email",children:"Email address"}),e.jsx("input",{id:"email",type:"email",placeholder:"you@example.com",className:"border-border bg-card text-body focus:ring-sunflower h-10 w-64 rounded-md border px-3 font-sans focus:ring-2 focus:ring-offset-2 focus:outline-none"})]})},l={render:()=>e.jsx("div",{className:"flex flex-col gap-4",children:e.jsxs("div",{children:[e.jsx("h3",{className:"text-small text-secondary mb-3 font-medium",children:"Sizes"}),e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx(o,{size:"default",children:"Default size label"}),e.jsx(o,{size:"sm",children:"Small size label"})]})]})})};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
